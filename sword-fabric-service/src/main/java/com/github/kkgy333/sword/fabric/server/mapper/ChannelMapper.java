...
public interface ChannelMapper {
    ...
    @Update("update channel set name=#{c.name} where id=#{c.id}")
    ...
    @Select("select id,name,peer_id,date from channel where name=#{c.name} and peer_id=#{c.peerId}")
    @Results({
    ...
    @Select("select id,name,peer_id,date from channel where id=#{id}")
    @Results({
            @Result(property = "id", column = "id"),
            @Result(property = "name", column = "name"),
            @Result(property = "peerId", column = "peer_id"),
    ...
    @Select("select id,name,peer_id,date from channel where peer_id=#{id}")
    @Results({
            @Result(property = "id", column = "id"),
            @Result(property = "name", column = "name"),
            @Result(property = "peerId", column = "peer_id"),
    ...
    @Select("select id,name,peer_id,date from channel")
    @Results({
            @Result(property = "id", column = "id"),
            @Result(property = "name", column = "name"),
            @Result(property = "peerId", column = "peer_id"),
